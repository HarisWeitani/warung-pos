            ...
            items(methods, key = { it.id }) { method ->
                Row(
                    ...
                    Text(
                        ...
                        color = if (method.isActive) MaterialTheme.colorScheme.onSurface else MaterialTheme.colorScheme.onSurfaceVariant,
                    )
                    Switch(checked = method.isActive, onCheckedChange = { onToggleActive(method) })
                }
            }
        }
    }
